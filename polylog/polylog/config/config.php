...
return [
    ...
    |
    */
    'http_logging' => env('POLYLOG_HTTP_LOGGING'),
    'route_logging' => env('POLYLOG_ROUTE_LOGGING'),
    'app_name' => env('APP_NAME'),
    'write_os_stats' => env('POLYLOG_ON_STATS', false),
    "route_log_driver" => env('POLYLOG_ROUTE_LOG_DRIVER', "logstash"),
    ...
    "log_driver" => [
        ...
        "logstash" => [
            ...
            'handler_with' => [
                ...
                'port' => env('POLYLOG_LOGSTASH_PORT', 161),
            ],
        ...
        "logstash_route" => [
            ...
            'handler_with' => [
                ...
                'user' => env('POLYLOG_LOGSTASH_USER', 'logstash'),
                'password' => env('POLYLOG_LOGSTASH_PASSWORD', 'secret'),
                'port' => env('POLYLOG_ROUTE_LOGSTASH_PORT', 5046),
            ],
            'formatter' => \Alifuz\Polylog\Formatters\LogstashFormatter::class,
            'formatter_with' => [
                'app_name' => config('app.name', 'undefined_name'),
